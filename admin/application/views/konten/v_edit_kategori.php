    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit <?PHP echo $kategori['judul']; ?></li>
      </ol>
    </section>
    ...
    <section class="content">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-plus"></i> <?PHP echo $kategori['judul']; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('konten/kategori/action_edit/'.$kategori['id'].'/'.$kategori['judul'] , array('class' => 'form-horizontal')); ?>
            <input type="hidden" name="url-edit-konten" value="<?PHP echo $url; ?>">
              <div class="box-body">
                <div class="form-group <?PHP if(form_error('judul')){echo 'has-error';} ?>">
                  ...
                  <div class="col-sm-10">
                    <?php echo form_input(array('id' => 'judul', 'name' => 'judul', 'class' => 'form-control' , 'value' => $kategori['judul'])); ?>
